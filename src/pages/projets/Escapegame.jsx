        ...
        <div className="font-poppins py-12 bg-white-smoke min-h-screen">
            <div className="container mx-auto px-4">
                ...
                <p className="text-lg text-slate-gray mb-4">
                    Durant la première année de BUT Informatique, j'ai été amené à imaginer un Escape Game avec mon
                    groupe, en élaborant une affiche de communication pour celui-ci pour commencer.
                </p>
                <p className="text-lg text-slate-gray mb-6">
                    Par la suite, nous devions concevoir le site Web de l'Escape Game qu'un autre groupe avait réfléchi,
                ...
                <div className="mb-6">
                    <img
                        src=".././images/site-escapegame.jpg"
                        alt="[IMAGE SITE ESCAPE GAME]"
